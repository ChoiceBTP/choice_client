    ...
    const handleInput = () => {
        ...
        async function getChatResponse() {
            const requestOptions = {
                ...
                body: JSON.stringify({"input_string":inputRef.value})
            };
            getBotMessage.innerText = "Typing...";
            const response = await fetch('/getPred/', requestOptions);
            const json_response = await response.json();
            console.log("see res ", json_response);
            getBotMessage.innerText = json_response["message"];
        }
